...
max_l0 = max(log10(S1.Lambda0(buf1)));
buf2 = round(buf2);
...
x = [10^(-11) 1000 1000 10^(-11)];
y = [0.95 0.95  1.0 1.0];
patch(x,y,cmap(Lcolor(1),:),'FaceAlpha',.1,'LineStyle','none');

x = [10^(-11) 1000 1000 10^(-11)];
y = [0.45 0.45 0.55 0.55];
patch(x,y,cmap(Lcolor(2),:),'FaceAlpha',.1,'LineStyle','none');


x = [10^(-11) 1000 1000 10^(-11)];
y = [0.05 0.05 0.15 0.15];
patch(x,y,cmap(Lcolor(3),:),'FaceAlpha',.1,'LineStyle','none');
...
x = [10^(-11) 1000 1000 10^(-11)];
y = [0.95 0.95  1.0 1.0];
patch(x,y,cmap(Tcolor(1),:),'FaceAlpha',.1,'LineStyle','none');

x = [10^(-11) 1000 1000 10^(-11)];
y = [0.45 0.45 0.55 0.55];
patch(x,y,cmap(Tcolor(2),:),'FaceAlpha',.1,'LineStyle','none');


x = [10^(-11) 1000 1000 10^(-11)];
y = [0.05 0.05 0.15 0.15];
patch(x,y,cmap(Tcolor(3),:),'FaceAlpha',.1,'LineStyle','none');
...
x = [10^(-11) 1000 1000 10^(-11)];
y = [0.95 0.95  1.0 1.0];
patch(x,y,cmap(NLcolor(1),:),'FaceAlpha',.1,'LineStyle','none');

x = [10^(-11) 1000 1000 10^(-11)];
y = [0.45 0.45 0.55 0.55];
patch(x,y,cmap(NLcolor(2),:),'FaceAlpha',.1,'LineStyle','none');


x = [10^(-11) 1000 1000 10^(-11)];
y = [0.05 0.05 0.15 0.15];
patch(x,y,cmap(NLcolor(3),:),'FaceAlpha',.1,'LineStyle','none');


xline(Nlinear_critical_lambda(1),'LineWidth',1.1,'Color',cmap(NLcolor(1),:),'LineStyle',':')
xline(Nlinear_critical_lambda(2),'LineWidth',1.1,'Color',cmap(NLcolor(2),:),'LineStyle',':')
xline(Nlinear_critical_lambda(3),'LineWidth',1.1,'Color',cmap(NLcolor(3),:),'LineStyle',':')
...
t1.Position = [px+0.28+0.03,py,0.05,0.05];
...
t2.Position = [px+0.28*2+0.05,py,0.05,0.05];
...
t3.Position = [px,py-0.40,0.05,0.05];
...
t4.Position = [px+0.28+0.03,py-0.40,0.05,0.05];
...
t5.Position = [px+0.28*2+0.05,py-0.40,0.05,0.05];
